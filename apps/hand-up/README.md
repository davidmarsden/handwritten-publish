...
Hand Up should let a user select many supported files, upload them to Micro.blog, and copy useful results without opening the document-publishing workflow.
